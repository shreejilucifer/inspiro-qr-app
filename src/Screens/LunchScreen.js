...
import LunchScreenContent from './LunchScreenContent';
      ...
      <View style={styles.lunchscreenContainer}>
        {
          ...
          <View style={styles.contentContainer}>
            ...
            <Text style={styles.myTextError}>{state.responseMessage}</Text>
            <Text style={styles.myTextError}>{state.qrName}</Text>
            <Button
...

        {
          ...
          <View style={styles.contentContainer}>
            <Text style={styles.myText}>{state.responseMessage}</Text>
            <Text style={styles.myText}>{state.qrName}</Text>
            <Button
...

        {
          ...
          <LunchScreenContent Consumer={Consumer} /> : <View></View>
        }
